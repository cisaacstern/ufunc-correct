...
<div id="slope-modal" class="invisible">
  <div class="modal-content">
    <span id="close-slope" class="close">&times;</span>
    <h3>Here's the Slope Plot</h3>
    {{ embed(roots.D) }}
  </div>
</div>

<div id="aspect-modal" class="invisible">
  <div class="modal-content">
    <span id="close-aspect" class="close">&times;</span>
    <h3>Here's the Aspect Plot</h3>
    {{ embed(roots.E) }}
  </div>
</div>
...
<div id="sun-modal" class="invisible">
  <div class="modal-content">
    <span id="close-sun" class="close">&times;</span>
